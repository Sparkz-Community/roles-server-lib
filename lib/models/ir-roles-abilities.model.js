...
module.exports = function (app,{connection, extend_schema = {}, schema_remove_paths = []} = {}) {
  ...
  const modelName = 'ir-roles-abilities';
  ...
  const orig_schema = {
    ...
    //   type: Array,
    //   required: false,
    //   contains: {type: Schema.Types.ObjectId, ref: 'ir-roles-roles'}
    // },
    inRoles:[ {type: Schema.Types.ObjectId, ref: 'ir-roles-roles'}],
    rules: [{ type: Schema.Types.ObjectId, ref: 'ir-roles-rules' }],
